...
Sections moved out of `docs/todo.md` once their work shipped, was
withdrawn, or was closed by measurement. They are kept verbatim — the
measurements and reasoning are the record, and several of them exist
precisely so a result doesn't get re-derived (or a false positive
